...
Component.options.__file = "C:\\xampp\\htdocs\\inventory_vue__\\resources\\assets\\js\\components\\Loader\\Loader.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-35c5cad4", Component.options)
  } else {
    hotAPI.reload("data-v-35c5cad4", Component.options)
  }
})()}
...
Component.options.__file = "C:\\xampp\\htdocs\\inventory_vue__\\resources\\assets\\js\\components\\Transfers\\Select2.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4cf11814", Component.options)
  } else {
    hotAPI.reload("data-v-4cf11814", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-35c5cad4", module.exports)
  }
}
...
var update = __webpack_require__(12)("296f2f48", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-35c5cad4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Loader.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-35c5cad4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Loader.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Filtering_brandStates_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Filtering_categoryStates_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Filtering_descriptionStates_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Filtering_ManufacturesStates_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Filtering_locationState_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Filtering_productStates_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Filtering_statusStates_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Filtering_fetchAll_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Filtering_fetchData_js__ = __webpack_require__(154);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        Select2: __WEBPACK_IMPORTED_MODULE_0__Transfers_Select2_vue___default.a, Loader: __WEBPACK_IMPORTED_MODULE_1__Loader_Loader_vue___default.a
    },
    data: function data() {
        return {
            loading: true,
            dataFetch: __WEBPACK_IMPORTED_MODULE_11__Filtering_fetchData_js__["a" /* default */].data,
            hasError: false,
            arrayUrl: {
            ...
            arrayCollection: {
                model: __WEBPACK_IMPORTED_MODULE_3__Filtering_brandStates_js__["a" /* default */].data,
                categories: __WEBPACK_IMPORTED_MODULE_4__Filtering_categoryStates_js__["a" /* default */].data,
                products: __WEBPACK_IMPORTED_MODULE_8__Filtering_productStates_js__["a" /* default */].data,
                descriptions: __WEBPACK_IMPORTED_MODULE_5__Filtering_descriptionStates_js__["a" /* default */].data,
                manufactures: __WEBPACK_IMPORTED_MODULE_6__Filtering_ManufacturesStates_js__["a" /* default */].data,
                locations: __WEBPACK_IMPORTED_MODULE_7__Filtering_locationState_js__["a" /* default */].data,
                statuses: __WEBPACK_IMPORTED_MODULE_9__Filtering_statusStates_js__["a" /* default */].data
    ...
    methods: {
        ...
        fetchAll: function fetchAll(dataId) {
            ...
            var data = dataId;
            //fetchAll.fetchAll()
            __WEBPACK_IMPORTED_MODULE_11__Filtering_fetchData_js__["a" /* default */].fetchData('../../api/products/' + data + '/edit');
        }
    }
});
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    fetchData: function fetchData(data) {
        ...
        axios.get(data).then(function (response) {
            ...
            var pick = _.pick(response.data.data, 'id', 'quantity', 'serial', 'assetSerial', 'manufacture', 'description', 'location', 'category', 'brand', 'status');
            ...
            }, _defineProperty(_vm$data$dataFetch, 'status', pick.status), _defineProperty(_vm$data$dataFetch, 'serialClone', pick.serial), _defineProperty(_vm$data$dataFetch, 'assetSerialClone', pick.assetSerial), _vm$data$dataFetch);
        });
    }
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
  ...
  }, [_vm._v("Edit " + _vm._s(_vm.dataFetch.dataFetch.serial))]), _vm._v(" "), _c('div', {
    ...
    domProps: {
      "checked": Array.isArray(_vm.checkedType) ? _vm._i(_vm.checkedType, null) > -1 : (_vm.checkedType)
    },
    on: {
      "__c": function($event) {
        var $$a = _vm.checkedType,
          $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$c) {
            $$i < 0 && (_vm.checkedType = $$a.concat($$v))
          } else {
            $$i > -1 && (_vm.checkedType = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.checkedType = $$c
        }
  ...
  }), _vm._v(" "), _c('label', [_vm._v("Type: " + _vm._s(_vm.checkedType ? 'Non-Consumable' : 'Consumable') + "  ")])]), _vm._v(" "), _c('div', {
    staticClass: "form-group",
    class: {
      'has-error': _vm.validateDuplicate
    }
  }, [_c('label', [_vm._v(_vm._s(_vm.checkedType ? 'Serial' : 'Name'))]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    directives: [{
      ...
      value: (_vm.checkedType ? (_vm.validateSerialQuantity ? _vm.dataFetch.dataFetch.quantity = 1 : _vm.dataFetch.dataFetch.quantity) : _vm.dataFetch.dataFetch.quantity),
      expression: "checkedType ? (validateSerialQuantity ? dataFetch.dataFetch.quantity = 1 : dataFetch.dataFetch.quantity) :  dataFetch.dataFetch.quantity",
      modifiers: {
        "number": true
      }
    }],
    ...
    attrs: {
      "min": "1",
      "disabled": _vm.checkedType ? (_vm.validateSerialQuantity ? _vm.dataFetch.dataFetch.quantity = 1 : _vm.dataFetch.dataFetch.quantity) : false,
      "type": "number"
    },
    domProps: {
      "value": (_vm.checkedType ? (_vm.validateSerialQuantity ? _vm.dataFetch.dataFetch.quantity = 1 : _vm.dataFetch.dataFetch.quantity) : _vm.dataFetch.dataFetch.quantity)
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.checkedType ? (_vm.validateSerialQuantity ? _vm.dataFetch.dataFetch.quantity = 1 : _vm.dataFetch.dataFetch.quantity) : _vm.dataFetch.dataFetch.quantity = _vm._n($event.target.value)
      },
      "blur": function($event) {
        _vm.$forceUpdate()
      }
    ...
    model: {
      ...
      callback: function($$v) {
        _vm.dataFetch.dataFetch.manufacture.id = $$v
      },
    ...
    model: {
      ...
      callback: function($$v) {
        _vm.dataFetch.dataFetch.description.id = $$v
      },
    ...
    on: {
      "modelId": function($event) {
        _vm.dataFetch.dataFetch.id = $event
      }
    },
    model: {
      value: (_vm.dataFetch.dataFetch.location.id),
      callback: function($$v) {
        _vm.dataFetch.dataFetch.location.id = $$v
      },
    ...
    model: {
      ...
      callback: function($$v) {
        _vm.dataFetch.dataFetch.category.id = $$v
      },
    ...
    model: {
      ...
      callback: function($$v) {
        _vm.dataFetch.dataFetch.model.id = $$v
      },
    ...
    on: {
      "modelId": function($event) {
        _vm.dataFetch.dataFetch.status.id = $event
      }
    },
    model: {
      value: (_vm.dataFetch.dataFetch.status.id),
      callback: function($$v) {
        _vm.dataFetch.dataFetch.status.id = $$v
      },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6a1751fa", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(12)("db57edce", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6a1751fa\",\"scoped\":false,\"hasInlineConfig\":true}!./noty.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6a1751fa\",\"scoped\":false,\"hasInlineConfig\":true}!./noty.css");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
Component.options.__file = "C:\\xampp\\htdocs\\inventory_vue__\\resources\\assets\\js\\components\\Products\\edit.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6a1751fa", Component.options)
  } else {
    hotAPI.reload("data-v-6a1751fa", Component.options)
  }
})()}
