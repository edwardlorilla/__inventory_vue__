...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
  ...
  }, [_c('label', [_vm._v("Serial")]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    directives: [{
      ...
      value: (_vm.validateSerialQuantity ? _vm.dataFetch.dataFetch.quantity = 1 : _vm.dataFetch.dataFetch.quantity),
      expression: "validateSerialQuantity ? dataFetch.dataFetch.quantity = 1 : dataFetch.dataFetch.quantity",
      modifiers: {
        "number": true
      }
    }],
    ...
    attrs: {
      "min": "1",
      "type": "number",
      "disabled": _vm.validateSerialQuantity
    },
    domProps: {
      "value": (_vm.validateSerialQuantity ? _vm.dataFetch.dataFetch.quantity = 1 : _vm.dataFetch.dataFetch.quantity)
    },
    on: {
      ...
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.validateSerialQuantity ? _vm.dataFetch.dataFetch.quantity = 1 : _vm.dataFetch.dataFetch.quantity = _vm._n($event.target.value)
      },
      "blur": function($event) {
        _vm.$forceUpdate()
      }
