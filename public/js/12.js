...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Filtering_Filter_vue__ = __webpack_require__(88);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5eddfc60", module.exports)
  }
}
...
var update = __webpack_require__(12)("824669e4", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-5eddfc60\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-5eddfc60\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
...
Component.options.__file = "C:\\xampp\\htdocs\\inventory_vue__\\resources\\assets\\js\\components\\Transfers\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5eddfc60", Component.options)
  } else {
    hotAPI.reload("data-v-5eddfc60", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    return _c('tr', {
      ...
      }, [_vm._v(_vm._s(entry[key]))])], 1) : (entry[key] === entry['name'] && _vm.titleHead === 'Manufactures') ? _c('span', [_c('router-link', {
        attrs: {
          "to": '/manufactures/' + entry['id'] + '/edit'
        }
      }, [_vm._v(_vm._s(entry[key]))])], 1) : (entry[key] === entry['name'] && _vm.titleHead === 'Locations') ? _c('span', [_c('router-link', {
        attrs: {
          "to": '/locations/' + entry['id'] + '/edit'
        }
      }, [_vm._v(_vm._s(entry[key]))])], 1) : (entry[key] === entry['name'] && _vm.titleHead === 'Descriptions') ? _c('span', [_c('router-link', {
        attrs: {
          "to": '/descriptions/' + entry['id'] + '/edit'
        }
      }, [_vm._v(_vm._s(entry[key]))])], 1) : (entry[key] === entry['name'] && _vm.titleHead === 'Categories') ? _c('span', [_c('router-link', {
        attrs: {
          "to": '/categories/' + entry['id'] + '/edit'
        }
      }, [_vm._v(_vm._s(entry[key]))])], 1) : (entry[key] === entry['name'] && _vm.titleHead === 'Models') ? _c('span', [_c('router-link', {
        attrs: {
          "to": '/brands/' + entry['id'] + '/edit'
        }
      }, [_vm._v(_vm._s(entry[key]))])], 1) : _c('span', [_vm._v(_vm._s(entry[key]))])])
    }))
  }))], 1)]), _vm._v(" "), _c('nav', {
    attrs: {
